...
export default function Transfer() {
  ...
  const OtherBanksFormInputs = [
    { label: "Full name", id: "full_name", value: state.full_name, type: "string" },
    { label: "Account Number", id: "account", value: state.account, type: "number" },
  ...
  const [banks, setBanks] = React.useState([...Banks
  ]);
  ...
  const [selected, setSelected] = React.useState(banks[0]);
  React.useEffect(()=>{
    setSelected(banks[0])
  },[banks])
        ...
        >
          <div className="">
              ...
              <div className="flex justify-end w-full">
                <button type="button" className="text-white bg-indigo-700 rounded-md p-2" onClick={CheckAccountNumber}>{"check"}</button>
              </div>
              }
              {
                showAmount &&
